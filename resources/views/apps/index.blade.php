...
<body class="bg-slate-100 font-sans" x-data="appsManager()">
    ...
    <div x-data="pageLayout()" :class="collapsed ? 'lg:ml-16' : 'lg:ml-64'"
        ...
        <div class="flex flex-wrap justify-between items-center gap-3 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Daftar Aplikasi</h1>
                <p class="text-sm text-gray-500 mt-1">
                    Kelola aplikasi yang tampil di portal SIT
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Total Aplikasi</p>
                        <p class="text-3xl font-bold text-gray-900 mt-1">{{ $apps->count() }}</p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-emerald-600 mt-1">
                            {{ $apps->where('is_active', true)->count() }}
                        </p>
                    </div>
            ...
            <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wider">Total Slide</p>
                        <p class="text-3xl font-bold text-violet-600 mt-1">
                            {{ $apps->pluck('slide')->unique()->count() }}
                        </p>
                    </div>
                    ...
                    <thead class="bg-gray-50 border-b border-gray-100">
                        <tr>
                            ...
                            <th
                                ...
                                Slide</th>
                            <th
                                class="px-5 py-3.5 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider w-20">
                                Urutan</th>
                            <th
                                class="px-5 py-3.5 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider w-28">
                                Status</th>
                            <th
                                class="px-5 py-3.5 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider w-24">
                                Gambar</th>
                            <th
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        @else
                                            <div
                                                class="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-100 to-violet-100
                                ...
                                <td class="px-5 py-4 text-center">
                                    @if ($app->gambar)
                                        <img src="{{ asset('storage/' . $app->gambar) }}" alt="{{ $app->nama }}"
                                            class="w-12 h-12 object-cover rounded-lg mx-auto border border-gray-200">
                                    @else
                                        <div
                                            class="w-12 h-12 rounded-lg bg-gray-100 flex items-center justify-center mx-auto">
    ...
    <script>
        function appsManager() {
            return {
                ...
                openDeleteModal(id, nama, action) {
                    this.deleteTarget = {
                        id,
                        nama,
                        action
