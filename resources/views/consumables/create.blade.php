...
<head>
    ...
    <title>Tambah Konsumable — SIAM</title>
...
<body class="bg-slate-100 font-sans">
    ...
    <x-header title="Tambah Konsumable" />
    <x-sidebar />
        ...
        <div class="max-w-3xl mx-auto space-y-6">
            <div>
                <a href="{{ route('siam.consumables.index') }}" class="text-sm text-indigo-600 hover:underline">←
                    Kembali</a>
                <h1 class="text-2xl font-bold text-gray-800 mt-1">Tambah Konsumable</h1>
            </div>
            ...
            <form method="POST" action="{{ route('siam.consumables.store') }}"
                ...
                <div>
                    ...
                    <input type="text" name="name" required value="{{ old('name') }}"
                        placeholder="Contoh: Mouse Logitech M170"
                ...
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="stock_total" required min="0"
                            value="{{ old('stock_total', 0) }}" class="w-full border rounded-lg px-3 py-2 text-sm">
                    </div>
                    <div>
                        ...
                        <input type="number" name="stock_available" required min="0"
                            value="{{ old('stock_available', 0) }}" class="w-full border rounded-lg px-3 py-2 text-sm">
                    </div>
                    <div>
                        ...
                        <input type="number" name="stock_minimum" required min="0"
                            value="{{ old('stock_minimum', 0) }}" class="w-full border rounded-lg px-3 py-2 text-sm">
                    </div>
                </div>

                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Harga Terakhir (Rp)</label>
                    <input type="number" name="last_price" min="0" value="{{ old('last_price') }}"
                        class="w-full border rounded-lg px-3 py-2 text-sm">
                </div>
