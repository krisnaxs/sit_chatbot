...
<head>
    ...
    <title>Tambah Vendor - SIAM</title>
    ...
    <div x-data="pageLayout()" :class="collapsed ? 'lg:ml-16' : 'lg:ml-64'"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
            ...
            <div class="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Tambah Vendor</h1>
                    <p class="text-sm text-gray-500 mt-0.5">Vendor sewa atau pembelian aset IT</p>
                </div>
            </div>
            ...
            <form action="{{ route('siam.vendors.store') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                        placeholder="Contoh: PT Lenovo Indonesia"
        ...
        'both' => ['Sewa & Beli', 'violet'],
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" value="{{ old('phone') }}"
                            placeholder="Contoh: 021-5550001"
                            class="w-full border rounded-xl px-3 py-2.5 text-sm
                                   focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent
                                   border-gray-200">
                    </div>
                ...
                <div>
                    ...
                    <textarea name="address" rows="3" placeholder="Alamat lengkap vendor..."
                        class="w-full border rounded-xl px-3 py-2.5 text-sm
                               focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent
                               border-gray-200">{{ old('address') }}</textarea>
                </div>
