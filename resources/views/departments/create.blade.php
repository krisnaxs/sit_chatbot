...
<head>
    ...
    <title>Tambah Departemen - SIAM</title>

    <link rel="icon" href="{{ asset('images/fav_icon.png') }}" type="image/png">
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>

<body class="bg-slate-100 font-sans" x-data="deptForm()">

    <x-header title="Tambah Departemen" />
    <x-sidebar />
    ...
    <div x-data="pageLayout()" :class="collapsed ? 'lg:ml-16' : 'lg:ml-64'"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
            ...
            <div class="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
                ...
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Tambah Departemen</h1>
                    <p class="text-sm text-gray-500 mt-0.5">Tambah departemen baru ke sistem</p>
                </div>
            </div>

            <form action="{{ route('siam.departments.store') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        @enderror
                        <p class="text-xs text-gray-400 mt-1">Contoh: IT, FIN, HRD, MKT.</p>
                    </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" placeholder="Deskripsi singkat departemen..."
                        class="w-full border rounded-xl px-3 py-2.5 text-sm
                               focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent
